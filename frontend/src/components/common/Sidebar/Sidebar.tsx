...
const Sidebar = () => {
  ...
  return (
    <nav className="min-w-sidebar w-sidebar h-screen flex flex-col border-r-custom-s gap-1.5 justify-between overflow-y-hidden bg-white transition-colors dark:bg-gray-black dark:border-r-gray-400">
      <div>
        <header className="text-green-400 text-5xl text-center py-7 font-bold hover:tracking-widest transition-all duration-700 font-raleway dark:text-green-100">
      ...
      <div className="pb-4 px-6 inline-flex items-center justify-between">
        <a
          className="text-medium-m dark:text-white text-black hover:text-gray-500"
