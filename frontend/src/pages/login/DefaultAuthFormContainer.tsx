...
import { MdOutlineVisibility, BiHide } from "@/components/Icons";
...
const INPUT_CLASSNAME = "w-full px-4 py-3 bg-white border border-gray-300 rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent";
